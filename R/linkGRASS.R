...
#'  \href{https://grass.osgeo.org/download/windows/}{'GRASS 7/8' stand-alone} installation, 
...
#'  \href{https://CRAN.R-project.org/package=rgrass}{rgrass} environment including the correct 'GRASS 7/8' structure.\cr\cr
