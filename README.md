...
`initProj` provides a complete and flexible lightweight working environment for GI
...
configure paths,run).](https://raw.githubusercontent.com/r-spatial/link2GI/master/figures/usegui.gif)
