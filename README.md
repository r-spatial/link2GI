...
Provides functions to access of the most important open source GIS/RS and image analysis command line tools from R.  It focuses on `Linux` and `WindowsX` operating systems but nevertheless it should also work with `OSX`. 
