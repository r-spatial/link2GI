...
A comprehensive introduction to the spatial R-biotope and its backgrounds is excellently treated in [Geogomputation with R](https://geocompr.robinlovelace.net) wich is highly recommend as a reference textbook.
