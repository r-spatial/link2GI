...
vignette: >
  %\VignetteIndexEntry{Create reproducible project structures in link2GI}
...
![Animated demonstration of the link2GI GUI workflow](https://raw.githubusercontent.com/r-spatial/link2GI/master/figures/usegui.gif)
...
This section provides a **minimal, canonical workflow** for spatial R projects using `link2GI`. It is intended as a **quick entry point** before the more detailed explanations below. However it will cover most  standard demands
...
> do **not** call `initProj()` again no matter where
...
* do not use `setwd()`
* do not call `initProj()` inside an existing project this duplicate folder-creation logic
