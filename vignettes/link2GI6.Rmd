...
A nice alternative is the trizen package manager. first install trizen from the github repository.
```sh
...
```
.
Than you can easily search and install qgis and the other GI packages
```sh
trizen qgis
```
